...
${OBJECTDIR}/src/ADC.o: src/ADC.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/src/ADC.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"src/" -I"src/OLED/" -I"../" -I"../../Common/include/" -I"../../../Source/portable/MPLAB/PIC32MZ/" -I"../../../Source/include/" -MMD -MF "${OBJECTDIR}/src/ADC.o.d" -o ${OBJECTDIR}/src/ADC.o src/ADC.c    -DXPRJ_PIC32MZ2048ECG100=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
